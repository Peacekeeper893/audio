                ...
                <div className="flex justify-center py-12 ">
                    ...
                    <>
                        ...
                        {bookmarks.length === 0 ? (<div>
                            <h1 className=" text-2xl font-semibold flex justify-center pr-6  bg-slate-300">No Bookmarks Saved</h1>
                        </div>) :
                            
                            (
                                <div className="flex flex-col gap-4 md:p-4 p-1">
                                    {bookmarks.map((bookmark) => (
                                        <Bookmark bookmark={bookmark} book={book} onDelete={deleteBookmark}  playBookmark={playBookmark} />
                                    ))}
                                </div>
                            )
