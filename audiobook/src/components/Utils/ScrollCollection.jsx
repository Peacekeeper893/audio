...
const ScrollCollection = ({mostPopularBooks}) => {
    ...
    return (
        <div className="relative">
            <div
                className="absolute -left-3  top-[45%] transform -translate-y-[45%]  p-3 cursor-pointer rounded-full z-[50]"
                onClick={() => scroll(-600)}
            >
                <MdNavigateBefore
                    size={24}
            ...
            <div
                className="absolute -right-3 top-[45%] transform -translate-y-[45%]  p-3 cursor-pointer rounded-full z-[50]"
                onClick={() => scroll(600)}
            >
            ...
            <div
                className="relative flex overflow-x-scroll horizontal-scrollbar p-4 gap-6 md:gap-2"
                ref={scrollRef}
            >
